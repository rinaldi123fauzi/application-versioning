...
class PrioritiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create priority" do
    assert_difference('Priority.count') do
      post priorities_url, params: { priority: { deskripsi: @priority.deskripsi, nama: @priority.nama } }
    end
  ...
  test "should update priority" do
    patch priority_url(@priority), params: { priority: { deskripsi: @priority.deskripsi, nama: @priority.nama } }
